                 ...
                 <tbody>
                    {data?.categories?.map(category => (
                       <tr key={category._id} className="odd:bg-gray-800">
                          ...
                          <td className="p-3 capitalize text-sm font-normal text-gray-400"><Link to={`/dashboard/update-image-category/${category._id}`} className="btn btn-warning">edit Image</Link></td>
