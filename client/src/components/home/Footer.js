...
const Footer = () => {
  return (
    <footer className=" border-t border-gray-300  border-heading mt-9 md:mt-11 lg:mt-16 3xl:mt-20 lg:pt-6 2xl:pt-2">
  <div className="mx-auto max-w-[1920px] px-10 pt-6 md:px-8 2xl:px-16">
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 md:gap-9 xl:gap-5  pb-5 md:pb-14 lg:pb-16 2xl:pb-20 3xl:pb-24 lg:mb-0.5 2xl:mb-0 3xl:-mb-1 xl:grid-cols-6">
      <div className="pb-3 md:pb-0 undefined">
        ...
        <ul className="text-xs lg:text-sm text-body flex flex-col  space-y-3 lg:space-y-3.5">
          <li className="flex items-baseline">
            ...
            <a
              className="transition-colors pl-4 duration-200 hover:text-black"
